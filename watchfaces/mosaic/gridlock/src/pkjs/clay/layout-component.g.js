// generated from gridlock/src/pkjs/clay/builder/layout.manifest.ts by the family core's tools/clay-components/generate-components.ts
...
module.exports = {
  ...
  template: "<div class=\"component lb\">  <div class=\"lb-header\">    <p class=\"lb-desc\">Pick a layout, then drag icons in to place them.<br>Drag blocks to move or remove. Every edit is kept.</p>  </div>  <div class=\"lb-modes\"></div>  <div class=\"lb-middle-wrap\">    <div class=\"lb-bezel\">      <div class=\"lb-grid\"></div>      <div class=\"lb-actions-side\">        <button type=\"button\" class=\"lb-btn lb-preset\" data-preset=\"default\">Default</button>        <button type=\"button\" class=\"lb-btn lb-preset\" data-preset=\"1\">Health</button>        <button type=\"button\" class=\"lb-btn lb-preset\" data-preset=\"2\">Weather</button>        <button type=\"button\" class=\"lb-btn lb-preset\" data-preset=\"3\">Solar</button>        <button type=\"button\" class=\"lb-btn lb-preset\" data-preset=\"4\">Active</button>      </div>    </div>  </div>  <div class=\"lb-actions-bar\">    <button type=\"button\" class=\"lb-btn lb-btn-io\">Import / Export</button>    <button type=\"button\" class=\"lb-btn lb-btn-clear\">Clear</button>  </div>  <div class=\"lb-palette-container\"></div>  <input type=\"hidden\" class=\"lb-value\"></div>",
  ...
  initialize: function () {
    var __clayComponent = (() => {
      ...
      // watchfaces/mosaic/gridlock/src/pkjs/clay/builder/ts/layout/visuals.ts
      var visuals_exports = {};
      ...
      // watchfaces/mosaic/gridlock/src/pkjs/clay/builder/ts/layout/drag.ts
      var drag_exports = {};
      ...
      // watchfaces/mosaic/gridlock/src/pkjs/clay/builder/ts/layout/modes.ts
      var modes_exports = {};
      ...
      // watchfaces/mosaic/gridlock/src/pkjs/clay/builder/component-entry.js
      var require_component_entry = __commonJS({
        "watchfaces/mosaic/gridlock/src/pkjs/clay/builder/component-entry.js"(exports, module) {
          init_thumbs();
          init_overlay();
          init_io_panel();
          init_geometry();
