...
static void apply_layout(void)
{
    ...
    else
    {
        ...
        // a round screen has the whole beach for this layout, so the clock takes the bigger size
        // and fills the band between the shore and the date rather than floating in it
