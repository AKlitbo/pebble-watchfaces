...
#define MERIDIEM_TOP 131       ///< 2px under the digits' cap line, clearing the ridge beside them
...
#define MERIDIEM_TOP_BIG 151  ///< The colon channel, on the big clock's digits
