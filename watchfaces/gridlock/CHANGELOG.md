...
- Added a Goal Met Vibe for steps, calories, distance, and active minutes, with Short, Long, Double, seven celebration rhythms, and a Custom pattern you can type in yourself.
