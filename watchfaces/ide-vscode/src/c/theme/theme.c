/**
 * @file theme.c
 * @brief Per-theme lookups: background resource ids and editor text colours.
 *
 * The colours approximate VS Code's syntax palette within the Pebble-64 gamut:
 * keyword-blue for the clock, string-orange/red for the date, mint for the temp +
 * battery, and a light-blue for the steps. Light-theme colours are kept dark so they
