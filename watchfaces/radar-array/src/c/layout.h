...
// radar has no condition glyph and carries the whole coordinate string in the
// latitude slot so it omits the ZONE_COND and ZONE_LON that wider faces carry
enum
{
    ZONE_TIME,
    ZONE_MERIDIEM,
...
// --- Icons ---
// the 14px glyph centred on the baked amber cell at the left end of the date bar
