...
const FILE_ICONS = {
  ...
  // Erik Flowers, rendered into the 12x12 WX_ICON_SM slot
  'wi-clear-sm':        [WI('wi-day-sunny.svg'),    [12, 12]],
  'wi-night-clear-sm':  [WI('wi-night-clear.svg'),  [12, 12]],
  'wi-cloudy-sm':       [WI('wi-cloudy.svg'),       [12, 12]],
  'wi-fog-sm':          [WI('wi-fog.svg'),          [12, 12]],
  'wi-drizzle-sm':      [WI('wi-sprinkle.svg'),     [12, 12]],
  'wi-rain-sm':         [WI('wi-rain.svg'),         [12, 12]],
  'wi-sleet-sm':        [WI('wi-sleet.svg'),        [12, 12]],
  'wi-snow-sm':         [WI('wi-snow.svg'),         [12, 12]],
  'wi-showers-sm':      [WI('wi-showers.svg'),      [12, 12]],
  'wi-snow-wind-sm':    [WI('wi-snow-wind.svg'),    [12, 12]],
  'wi-thunderstorm-sm': [WI('wi-thunderstorm.svg'), [12, 12]],
  'wi-na-sm':           [WI('wi-na.svg'),           [12, 12]],
  // UXWing
