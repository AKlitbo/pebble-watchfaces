 ...
 *
 * A network error becomes a 'NET ERROR' status and an unparseable body a
 * 'BAD WX DATA' status, both finishing the request. On success the parsed
 * JSON is handed to onJson, which owns the provider-specific error checks
 * and result.
 *
 * @param {string} url
